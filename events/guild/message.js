...
module.exports = async (client, message) => {
  try {
    ...
    if (command){
        if (command.private && message.guild)
          return message.channel.send(new Discord.MessageEmbed()
                .setColor(ee.wrongcolor)
                .setFooter(ee.footertext,ee.footericon)
                .setTitle(`❌ Please use the \`${command.name}\` command in private DM's.`)
  ...
  /**
    * @INFO
    * Bot Coded by Merilairon#4695 | https://github.com/Tomato6966/Discord-Js-Handler-Template
    * @INFO
    * Work for Milrato Development | https://merilairon.com
    * @INFO
